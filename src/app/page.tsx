  ...
  return (
    ...
    <div className="text-table py-6">
        ...
        <p style={{textAlign: 'left', lineHeight: '1.15', marginTop:'6px'}}>
          <span style={{color: 'rgb(141, 141, 147)', fontSize: '13px'}}>
            1.<b>엘포인트 앱 접속:</b><br/> 엘포인트 앱을 실행하고,<br/>최상단 롤링 배너 중 <b><i>"고향사랑기부 X 리아 세트 증정"</i></b> 배너를 선택합니다.<br/>
            2.<b>기부하고자 하는 지자체 선택:</b><br/> 전국 지자체 중 기부하고자 하는 곳을 선택합니다.<br/>
            ※롯데리아 새우 버거와 함께 받고 싶은 3만원 상당의 답례품을 기준으로 선택해도 무방합니다.(한우세트, 성심당 파운드 등)<br/>
            3.<b>기부금액 설정 및 결제:</b><br/> 기부하고자 하는 금액을 설정하고 결제를 진행합니다.<br/>
            ※리아 새우 이벤트는 10만원 이상 기부 시 증정됩니다.<br/>
            4.<b>리아 새우 버거 세트 증정:</b><br/> 주 목요일 발송되는 쿠폰을 받습니다.(공휴일인 경우 영업일 기준 익일 발송) 
          </span>
        </p>
      </div>
      <div style={{ width: '100%', minHeight: '1px', height: '30px' }}></div>
